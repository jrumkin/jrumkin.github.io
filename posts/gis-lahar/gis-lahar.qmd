...
author: "Jessi Rumkin"
categories: [UCSB, GIS, research]
date: 05-25-2025
lightbox: TRUE
format: html
---

Capstone research project for the UCSB Geography 176A-C course series on geographic information systems and science (GIS).
...
![We won best visual element!](IMG_0840.JPEG){fig-alt="Research group in front of research poster with an award certificate"}
...
![Fig. 3 - Current AFM sites and predicted lahar risk zones](lahar_info.png){width="5in"}
